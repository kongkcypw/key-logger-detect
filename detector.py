...
class PacketSnifferDetector:
    def __init__(self, root):
        ...
        self.start_button = tk.Button(root, text="▶ Start", command=self.start_monitoring, bg="green", fg="white")
        self.start_button.pack(side=tk.LEFT, padx=10, pady=5)

        self.stop_button = tk.Button(root, text="⛔ Stop", command=self.stop_monitoring, bg="red", fg="white", state=tk.DISABLED)
